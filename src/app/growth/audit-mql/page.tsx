...
import { ShieldAlert, CheckCircle2, XCircle, Clock, ChevronLeft, ChevronDown, RefreshCw, AlertTriangle } from "lucide-react"
import type { LeadRecord } from "@/lib/audit-mql"
import LandingPageTab from "./LandingPageTab"
import DatePicker, { type DateRange, todayKey, fmtRangeLabel } from "./DatePicker"
    ...
    <div style={{ fontFamily: T.font, background: T.bg, minHeight: "100vh", padding: "24px 32px", color: T.fg }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          {(tab === "lead-ads" || tab === "landing-page") && (
            <DatePicker value={range} onChange={r => { setRange(r); setVerticalFilter(null) }} />
          )}
        </div>
      </div>
      ...
      {/* ── ABA LANDING PAGE ───────────────────────────────────────────────── */}
      {tab === "landing-page" && <LandingPageTab range={range} />}
